...
import { FaFacebookF, FaTwitter, FaLinkedinIn, FaInstagram, FaEnvelope, FaPhone, FaMapMarkerAlt, FaCalendarAlt } from 'react-icons/fa';
...
function Footer({data, styleTwo, styleThree}) {
    ...
    const {widgetAddress, widgetServices, widgetSolutions, widgetRecentPost, socials, copyrightText} = data

    return (
        <footer className={`footer ${styleTwo ? 'style--two' : styleThree ? 'style--three' : ''}`}>
                            ...
                            <div className="widget widget_contact">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <a href={`mailto:${widgetAddress.mail.link}`}>{widgetAddress.mail.text}</a>
                                    </li>
                                    <li>
                                        <span className="icon">
                                            <FaPhone />
                                        </span> 
                                        <a href={`callto:${widgetAddress.phone.link}`}>{widgetAddress.phone.text}</a>
                                    </li>
                                    <li>
                                        <span className="icon">
                                            <FaMapMarkerAlt />
                ...
                <Container>
                    <Row>
                        <Col>
                            ...
                            {copyrightText.firstText} <a href={copyrightText.link} className="bold">{copyrightText.linkText}</a> {copyrightText.lastText}
                            </div>
                        </Col>
                    </Row>
                </Container>
